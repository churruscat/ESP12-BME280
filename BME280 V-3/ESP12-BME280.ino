...
#define HUMEDAD_MIN  1  // valores de A0 para suelo seco y empapado
#define HUMEDAD_MAX  595
#define INTERVALOCONEX 30000 //30 seg en milisecs
...
float temperatura,humedadAire,presionHPa,lluvia,sensacion=20;
int  humedadMin,humedadMax,humedadSuelo,humedadCrudo;
int humedadCrudo1,humedadCrudo2;

// otras variables
uint32_t intervaloConex=INTERVALOCONEX;
...
boolean status;
 ...
 humedadCrudo1=(humedadMin+humedadMax)/2;
